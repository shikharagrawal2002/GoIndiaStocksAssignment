    ...
    <div className='relative left-0 top-0 w-full z-10 bg-white '>
        <div className='m-auto flex justify-between items-center text-black'> 
            <Link href='/' className='w-1/4'>
                <Image
                    className="h-[10%] w-[20%] ml-3 mr-3 sm:h-[50px] xs:h-full xs:w-[75%]"
                    alt="Image"
                    src={Logo}/>
            </Link>
            <div className='bg-grey h-[45px] rounded-md w-1/2 items-center flex justify-end p-3 m-4 xs:m-0'>
                <img
            ...
            <ul className='xs:hidden flex items-center mr-5 w-1/4 justify-end'>
                <li className='m-3'>
            ...
            <div className='flex md:hidden sm:hidden lg:hidden 2xl:hidden xl:hidden'>
                <Image className="w-full p-3" src={maleLogo} alt="Profile"/> 
            </div>
        </div>
    </div>
  )
